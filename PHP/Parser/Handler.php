...
interface PHP_Parser_Handler {
    ...
    function do_for_before_statement($semicolon1, $semicolon2);
    function do_for_cond($cond, $semicolon2);
    function do_for_end($semicolon2);
    ...
    function do_if_after_statement($rparen, $close);
    function do_if_cond($cond, $rparam);
    function do_if_end();
    ...
    function do_post_incdec(&$retval, $node, $op);
    function do_pre_incdec(&$retval, $node, $op);
    function do_print();
    ...
    function do_ticks();
    function do_try();
    function do_unary_op($op, &$retval, $node);
    function do_use();
